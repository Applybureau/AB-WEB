...
The backend includes 35+ professional email templates for all communication workflows:

### 🔐 Admin Email Templates
1. **admin_welcome.html** - Welcome new admin users
2. **admin_password_reset.html** - Admin password reset
...
15. **consultation_confirmed.html** - Consultation confirmation
...
18. **consultation_rescheduled.html** - Consultation rescheduling
19. **consultation_waitlisted.html** - Consultation waitlist notification
20. **new_consultation_booking.html** - New consultation booking notification
21. **new_consultation_request.html** - New consultation request
22. **new_consultation_request_with_times.html** - Consultation request with time slots
23. **meeting_scheduled.html** - Meeting scheduled confirmation
24. **meeting_link_notification.html** - Meeting link notification
25. **strategy_call_confirmed.html** - Strategy call confirmation
...
### 🏗️ Base Templates
35. **_base_template.html** - Base email template
36. **_secure_base_template.html** - Secure base template
...
### Support Information
- **Technical Support**: support@applybureau.com
- **Admin Access**: admin@applybureautest.com
...
curl -X POST https://apply-bureau-backend.vercel.app/api/auth/login \
  ...
  -d '{"email":"admin@applybureautest.com","password":"AdminTest123!"}'
```
...
*This documentation covers every aspect of the Apply Bureau Backend API. For additional support or questions, contact the development team at support@applybureau.com.*