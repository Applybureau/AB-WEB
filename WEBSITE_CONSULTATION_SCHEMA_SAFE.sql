-- Website Consultation Requests Schema (Safe Version)
...
DROP POLICY IF EXISTS "Admins can manage consultation requests" ON consultation_requests;
...
SELECT 'Website consultation requests schema applied successfully!' as status;