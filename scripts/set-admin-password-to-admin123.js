...
async function setAdminPasswordToAdmin123() {
  console.log('\n🔧 SETTING ADMIN PASSWORD TO admin123\n');
  ...
  try {
    ...
    console.log('\n📋 Step 2: Hashing password "admin123"...');
    const hashedPassword = await bcrypt.hash(newPassword, 12);
    ...
    if (passwordMatches) {
      console.log('\n🎉 SUCCESS! Password has been set to admin123');
      console.log('\n📝 Login Credentials:');
